...
app.get("/search/users", function (req, res) {
    // console.log(req)
  const {q} = req.query
  // console.log(req.query) //{ q: 'python' }
  // console.log(q) //python
  axios({
...
app.listen(5000, "localhost", (err) => {
  if (!err){
  	console.log("服務器啟動成功")
  	console.log("请求github真實數據請訪問：http://localhost:5000/search/users")
  	console.log("请求本地模擬數據請訪問：http://localhost:5000/search/users2")
  } 
